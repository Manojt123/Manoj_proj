...
public class ApplicationCentreLibrary extends CommonPages 
{
	public ApplicationCentreLibrary(WebDriver driver, Report oReport, Parameters oParameters) 
	{
	...
	By passwordTextBox = By.xpath("//input[@name='pwd']");

	By loginButton = By.xpath("//a[@id='loginButton']//div[contains(text(),'Login ')]");

	By nothingIsSelected = By.xpath("//a[text()='Logout']");
	...
	public void login(String login_Type) 
	{
		...
		if (oParameters.GetParameters("LOGIN_TYPE").equalsIgnoreCase("Manager_Mode")) 
		{
			oParameters.SetParameters("USER_NAME", oParameters.GetParameters("MANAGER_PORTAL_USER_NAME"));
			oParameters.SetParameters("PASSWORD", oParameters.GetParameters("MANAGER_PORTAL_PASSWORD"));
		} 
		else if (oParameters.GetParameters("LOGIN_TYPE").equalsIgnoreCase("User_Mode")) 
		{
			oParameters.SetParameters("USER_NAME", oParameters.GetParameters("USER_PORTAL_USER_NAME"));
			oParameters.SetParameters("PASSWORD", oParameters.GetParameters("USER_PORTAL_PASSWORD"));
		}
		else 
		{
	...
	//This method is used to navigate to any plugin/suit in Application centre portal
	...
	By timetrack = By.xpath("//div[contains(text(),'Time-Track')]");

	By tasks = By.xpath("//div[contains(text(),'Tasks')]");

	By reports = By.xpath("//div[contains(text(),'Reports')]");

	By users = By.xpath("//div[contains(text(),'Users')]");

	By workschedule = By.xpath("//div[contains(text(),'Work Schedule')]");

	By notifications = By.xpath("//div[contains(text(),'Notifications')]");
	...
	public void navigate_to_suit(String suitName) 
	{
		...
		{
			case "TIME_TRACK":
				click_button(suitName, timetrack);
				break;
			case "TASKS":
				click_button(suitName, tasks);
				break;
			case "REPORTS":
				click_button(suitName, reports);
				break;
			case "USERS":
				click_button(suitName, users);
				break;
			case "WORK_SCHEDULE":
				click_button(suitName, workschedule);
				break;
			case "NOTIFICATIONS":
				click_button(suitName, notifications);
				break;
		}
	}
	...
	public void navigate_to_plugin(String pluginName) 
	{
		...
		{
			case "TIME_TRACK":
				click_button(pluginName, timetrack);
				break;
	
			case "TASKS":
				click_button(pluginName, tasks);
				break;
			...
			case "USERS":
				click_button(pluginName, users);
				break;
				
			case "WORK_SCHEDULE":
				click_button(pluginName, workschedule);
				break;
				
			case "NOTIFICATIONS":
				click_button(pluginName, notifications);
				break;
		}
	}

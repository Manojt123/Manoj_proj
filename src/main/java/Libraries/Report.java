...
public class Report 
{
	...
	private void initialize_reports()
	{
		...
		if(oParameters.GetParameters("Report_PATH").equalsIgnoreCase("LOCAL"))
			reportPath = "C://ApplicationCentre//ExecutionReport//" + oParameters.GetParameters("ENVIRONMENT")+"//"+oParameters.GetParameters("CLASSNAME")+"//"+vrname+"//"+vrname+"-"+System.currentTimeMillis();
		else
			System.out.println("Virtual is not ready");
		
		String reportName = reportPath +"/"+vrname+"-"+System.currentTimeMillis()+".Html";
